...
fn take_screenshot(item: &GraphicsCaptureItem, save_dir: &str) -> Result<()> {
...
pub fn take_screenshot_for_windows(save_dir: &str, mode: CaptureMode) -> Result<()> {
    unsafe {
